...
public class Economico
{
    ...
    /**
     * Constructor-1 for objects of class economico
     */
    public Economico()
    {
        this.ap= "";
    ...
    /**
     * Constructor-2 for objects of class economico
     * 
     * @param  <tipo> de tipo String
     * @param  <nombre> de tipo String
     * @param  <genero> de tipo char
    */
    public Economico(String ap, String ci, String ca, String fe, double to, double num, char suc)
    {
        this.ap= ap;
        this.ci= ci;
        this.ca= ca;
