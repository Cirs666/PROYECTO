 ...
 */
public class Ventanacuarto extends JFrame implements ActionListener
{
    private Texto titulo= new Texto("Registro cuarto de pollo:", 10, 10, 150, 30);
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == btnAceptar) {
            ...
            Cuarto ra = new Cuarto(Ap, Ci, Ca,Fe, To ,Num, Suc); // Ajusta el constructor de cuarto según corresponda
            DBA.setCuarto(ra);
            setTitle("GUARDADO");
        ...
        if (e.getSource() == btnVisualizar) {
            try {
                ...
                Cuarto c = DBA.getCuartoPos(pos);
                if (c != null) {
                    tbAp.setText(c.getAp());
                    tbCi.setText(c.getCi());
                    tbCa.setText(c.getCa());
                    tbFe.setText(c.getFe());
                    tbTo.setText(String.valueOf(c.getTo()));
                    tbNum.setText(String.valueOf(c.getNum()));
                    tbSuc.setText(String.valueOf(c.getSuc()));
                } else {
